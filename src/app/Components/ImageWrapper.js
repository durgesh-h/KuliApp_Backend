  ...
  return (
    <div className=" bg-white  md:bg-slate-200  flex flex-col  items-center">
      <div className="relative mx-auto">
        {/* Top Image */}
        <div className="w-full  flex h-52 lg:h-72 justify-center shadow-lg  lg:mt-4 lg:mb-4 ">
        ...
        {/* Bottom Image */}
        <div className="w-full flex h-60 lg:h-72  justify-center lg:mt-4  lg:mb-4 mb-0 ">
